...
export const useLogStore = defineStore('log', {
  ...
  actions: {
    ...
    addNewMercenaryEventMultiple(mercenaries: Mercenary[], day?: number) {
    ...
    addNewContractEvenMultiple(contracts: BoardContract[], day?: number) {
    ...
    addMercenaryMoraleChange(params: {
      ...
      const { mercenaryName, reason, day, beforeMoral, afterMoral, intendedMoraleIncrease } =
        params;
