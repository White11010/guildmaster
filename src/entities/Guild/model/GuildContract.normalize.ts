import { type GuildContract, GuildContractStates } from '@/entities/Guild/model/Guild.types.ts';
...
export function normalizeGuildContract(contract: GuildContract): GuildContract {
  ...
  if (actualDurationDays === null && contract.state === GuildContractStates.IN_PROGRESS) {
