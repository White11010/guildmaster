 ...
 */
export function getContractSuccessChance(
    squadPower: number,
    ...
    if (R >= CONTRACT_SUCCESS_SQUAD_RATIO_FOR_90_PERCENT) {
        const span = CONTRACT_SUCCESS_SQUAD_RATIO_FOR_100_PERCENT - CONTRACT_SUCCESS_SQUAD_RATIO_FOR_90_PERCENT;
        const t =
            (R - CONTRACT_SUCCESS_SQUAD_RATIO_FOR_90_PERCENT) / span;
        return (
            CONTRACT_SUCCESS_CHANCE_AT_EQUAL_POWER +
            t *
                (CONTRACT_SUCCESS_CHANCE_AT_DOUBLE_POWER -
